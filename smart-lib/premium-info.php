...
<div class="wrap">
    ...
    <p><a href="https://creativemarket.com/netbiel/220298-MaxFlat-Fully-Responsive-Theme">MaxFlat Premium</a> adds exciting new customization features to the Theme Customizer and other powerful customization tools like shortcodes or layout options. </p>
    ...
    <div style="float: left; width: 40%; margin-left: 5%; ">
        <div id="submitdiv" class="postbox " style="margin-top: 40px;height: 355px;">
            ...
            <div class="inside">
                ...
                <a href="https://creativemarket.com/netbiel/220298-MaxFlat-Fully-Responsive-Theme" class="button button-primary" style="clear: both; margin-top: 210px" target="_blank"><strong>More info &raquo;</strong></a>
            </div>
